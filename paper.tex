...
\begin{figure}
\centering
\includegraphics[width=.5\textwidth]{inst/sim_study/generated/figures/results_true_control.pdf}
...
\begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{inst/oklahoma/paper/generated/figures/ATE_diff.pdf}
    \small
...
\begin{minipage}[t]{0.48\linewidth}
    \centering
    \includegraphics[width=\linewidth]{inst/oklahoma/paper/generated/figures/cumulative_count.pdf}
...
\begin{figure}[!ht]
\centering
\includegraphics[width=\textwidth]{inst/sim_study/generated/figures/results_estimated_control.pdf}
\caption{Estimated all-or-nothing DTAITE under oracle and naive labelling and the full SEM procedure. The dashed line marks the true value.}
...
\input{inst/oklahoma/paper/generated/tab_ok_sem_config}
