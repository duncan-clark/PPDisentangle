...
adaptive_SEM <- function(pp_data,
  ...
  ac_defaults <- list(
    ...
    max_relabel_step_frac = 1.0, max_map_relabel_step_frac = NA_real_,
  ...
  adaptive_step <- function(starting_data) {
    ...
    result <- do.call(
      ...
      c(
        list(
          ...
          max_map_relabel_step_frac = adaptive_control$max_map_relabel_step_frac,
          ...
          map_teleport_once = adaptive_control$map_teleport_once,
          label_init = adaptive_control$label_init,
    ...
    return(list(
      ...
      label_init = result$label_init,
      n_label_init_flips = result$n_label_init_flips,
  ...
  adaptive_summary <- list(
    ...
    label_init = adapt$label_init,
    n_label_init_flips = adapt$n_label_init_flips,
